...
def Die3(
    ...
    # StartY_1D_EC_B1 = AFQH_EC_B1[f"D{NDevices_AFQH_EC}"].ports["IN"].center[1] + FArrayGap + 600
...
if __name__ == "__main__":
    c = Die3()
    c.write_gds("Die3_test4.gds")
    print("Written Die3_test4.gds")
    c.show()
    c.plot()
