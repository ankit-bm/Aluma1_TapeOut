...
def Die1(DieWidth = 4488, DieHeight = 20780, TaperLength = 400, Layer = AL_Layers.CHS,):
    ...
    BlockParams = dict(
        ...
        BendRadiusIO = 15,
        BufLength    = 30,
        OffsetX_APF  = {"15": 20, "20": 20, "30": 20, "40": 20},
        OffsetY_APF  = {"15": 40, "20": 60, "30": 80, "40": 80},
        OffsetX_APFP = {"15": 20, "20": 20, "30": 20, "40": 20},
    ...
    BlockParamsPhC = dict(
        ...
        OffsetY_APF  = {"20": 60, "30": 80},
        OffsetX_APFP = {"20": 20, "30": 20},
        OffsetY_APFP = {"20": 80, "30": 80},

        NPerRowAPF   = {"20": 10, "30": 10},
        NPerRowAPFP  = {"20": 10, "30": 10},
...
if __name__ == "__main__":
    c = Die1()
    c.write_gds("Die1_test5.gds")
    print("Written Die1_test5.gds")
    c.show()
    c.plot()