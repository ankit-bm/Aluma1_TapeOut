...
###############################################################################
    ...
    if OutputIO:
        ...
        if OutIO == 2 and InIO == 2:
            ...
            LengthOX = InLengthX + 2*BendRadius + LengthRingX + 2*Gap + WgWidth + WgWidthIO
            ...
            LengthOX = TotLengthX - InLengthX - (LengthRingX + 2*BendRadius + 2*Gap + WgWidth + WgWidthIO)
            ...
            LengthOX = TotLengthX - InLengthX - (LengthRingX + 2*BendRadius + 2*Gap + WgWidth + WgWidthIO) - 2*BendRadiusIO
